...
| `permission.mode`          | `none`                    | Toggle reviewed auto mode           |
| `permission.cycle`         | `none`                    | Cycle prompt, accept edits, and auto |
| `permission.denials`       | `none`                    | Show recently denied auto mode actions |

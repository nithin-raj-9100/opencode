...
Configure the classifier used when reviewed auto mode handles permission prompts
in the TUI. The selected model must be available to the background service.

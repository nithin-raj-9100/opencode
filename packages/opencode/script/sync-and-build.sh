...
echo "==> Compiling native standalone V2 binary with shared database channel..."
OPENCODE_CHANNEL=latest OPENCODE_CLI_NAME=opencode bun run --cwd "$REPO_DIR/packages/cli" build --single

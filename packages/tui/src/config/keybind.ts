...
export const Definitions = {
  ...
  "permission.cycle": keybind("none", "Cycle permission mode: prompt, accept edits, auto"),
  ...
  "session.tab.next": keybind("ctrl+tab", "Switch to next open session tab"),
  "session.tab.previous": keybind("ctrl+shift+tab", "Switch to previous open session tab"),
  ...
  "session.message.user.next": keybind("alt+down", "Navigate to next user message"),
  "session.message.user.previous": keybind("alt+up", "Navigate to previous user message"),
